...
replace all instances of ``frontend-app-chat`` with the name of
...
1. Clone your new repo:
  ...
  ``git clone https://github.com/skillsenseroot/frontend-app-chat.git``
...
This section concerns development of ``frontend-app-chat`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-chat/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-chat/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-chat
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-chat.svg
    :target: https://github.com/openedx/frontend-app-chat/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-chat/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-chat/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-chat/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-chat?branch=main
    :alt: Codecov
